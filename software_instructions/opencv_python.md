...
2. 如果找到颜色阈值
	...
	```
<h2 id="title5.2">5.2 图形的几何变换 </h2>  
学习将不同的几何变换应用于图像，例如旋转，平移等。

**目标**

-   学习将不同的几何变换应用于图像，例如平移，旋转，仿射变换等。
-   您将看到以下功能：**[cv.getPerspectiveTransform](https://docs.opencv.org/4.5.1/da/d54/group__imgproc__transform.html#ga20f62aa3235d869c9956436c870893ae "根据四对对应点计算透视变换。 ")**

[参考链接](https://docs.opencv.org/4.5.1/da/d6e/tutorial_py_geometric_transformations.html)
...
*  函数说明
	...
	```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1ODE4NzUwOCwzOTI2ODA0MTAsNDIzOT
AyMjQzLDEyMzExMjMwNDgsNDA2MjY2NTQsLTE3NTcxODA2MTIs
LTU5MzYzMTQ4NywtMTUyNzM3ODkwNiwtMzc3MTI4NjU3LDQxMz
